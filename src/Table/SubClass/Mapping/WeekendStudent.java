...
public class WeekendStudent extends CurrentStudent {
	...
	public WeekendStudent(String sname,String city,String status,double totalfee,double feebal,String timings,String branch,String wcompany,String wcemail,double wctc){
	...
	public WeekendStudent(String wcemail, double wctc) {
		this.wcemail = wcemail;
		this.wctc = wctc;
	}
